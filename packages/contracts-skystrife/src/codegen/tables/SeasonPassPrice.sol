...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("SeasonPassPrice")))
);
ResourceId constant SeasonPassPriceTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0020010020000000000000000000000000000000000000000000000000000000
);

library SeasonPassPrice {
  /**
   ...
   * @notice Get price.
   */
  function _get() internal view returns (uint256 price) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set price.
   */
  function _set(uint256 price) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function encode(uint256 price) internal pure returns (bytes memory, PackedCounter, bytes memory) {
